...
export interface BrowserAgentCustomConfig {
  ...
  /** Require confirmation for sensitive actions (form submissions, file uploads). Default: true */
  confirmSensitiveActions?: boolean;
  /** Maximum actions per task to prevent runaway loops. Default: 100 */
  ...
  getBrowserAgentConfig(): {
    ...
    return {
      ...
      customConfig: {
        ...
        confirmSensitiveActions: customConfig.confirmSensitiveActions ?? true,
